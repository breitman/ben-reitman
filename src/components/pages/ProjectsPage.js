...
let projects = [
  ...
  },
  {
    ...
    name: "Tab-U-Later",
    description:
      "A Google Chrome extension that manages your tab sessions. With this tool, one can save Chrome windows to go back to at some other point in time.",
    goTo: "Go to Github",
  },
  {
  ...
  },
  {
    ...
    name: "malloc/free",
    description:
      "A mock implementation of the malloc and free routines run in C.",
    goTo: "Go to Github",
    disable: true,
  },
];
        ...
        <Container>
          {projects &&
            projects.map((project) => (
              <ProjCard className="card" project={project} key={count++} />
            ))}
        </Container>
      </div>
    );
